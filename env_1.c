...
int _mysetenv(info_t *information)
{
	...
	if (_mysetenv(information, information->argv[1], information->argv[2]))
		return (0);
	return (1);
}
...
/**
 *un_my_mysetenv -Structure potential.
 *@information: Structure containing potential.
 *
 *Return: Always 0
 */
int un_my_mysetenv(info_t *information)
{
	int l;
	...
	for (l = 1; l <= information->argc; l++)
		Un_mysetenv(information, information->argv[l]);
